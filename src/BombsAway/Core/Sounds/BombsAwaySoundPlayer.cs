...
namespace BombsAway.Core.Sounds
{
    /// <summary>
    /// This is the sound player, which relies on fmod.
    /// The latest version tested was "2.02.11"
    /// </summary>
    public partial class BombsAwaySoundPlayer : ISoundPlayer, IDisposable
    {
        public static BombsAwaySoundPlayer Instance => ((BombsAwaySoundPlayer)Game.Sound);
